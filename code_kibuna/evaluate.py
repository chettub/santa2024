...
version 29
https://www.kaggle.com/code/metric/santa-2024-metric

fix for batch_size > 1
https://www.kaggle.com/competitions/santa-2024/discussion/548249
...
class PerplexityCalculator:
    ...
    def __init__(
        ...
        # 初期化時にダミーの推論を実行してCUDAを初期化
        # with torch.no_grad():
        dummy_input = self.tokenizer(
            f"{self.tokenizer.bos_token}test{self.tokenizer.eos_token}",
            return_tensors='pt',
    ...
    def get_perplexity(
        self, input_texts: Union[str, List[str]], batch_size: int = 32
